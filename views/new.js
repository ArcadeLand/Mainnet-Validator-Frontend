...
export default function ChainSection() {
  ...
  const nearPools = [
      {"name": "Upgold", "link": "", "uptime": "99%"},
      {"name": "Maia", "link": "", "uptime": "99%"}
  ]

    return(
        <>
        <section className="section section-lg section-coins chains-section" id="chains-section" style={{ marginTop:"0px" }}>
        <img
            alt="..."
            className="path"
            ...
            <Row>
              ...
              <Col md="4">
                <Card className="card-coin card-plain">
                  ...
                  <CardFooter className="text-center">
                    <Button className="btn-default" color="info">
                      Stake Now
                    </Button>
                  </CardFooter>
                </Card>
